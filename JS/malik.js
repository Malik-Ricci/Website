...
"<br/><br/>The reasons why I chose to be a programmer started when I was around ten. I was old enough to count, but young enough to still be looking out for magic. Even after years of practice, I was struggling with math just like any regular child; Yet using no genius at all, only a couple of hours learning how to code in LUA allowed my friend and I to write a fully functional calculator! Ever since that day, I determined that programming was nothing less than magic!\n"+
...
function PxToVw(px){
    ...
    /**Iteratives*/
/**Blackbox function that uses regex to return
 * True if user is browsing with a mobile client.
 */
...
function doubleElement(){
    ...
    for(let i=0;i<divs.length;i++){
        if(!window.mobileCheck()){ //if desktop
            ...
            if(window.screen.availHeight<window.screen.availWidth){ //if horizontal
